...
SECRET_KEY = 'django-insecure-q1ih7sd*wt954u43p0g)32k(_vqlc2b%0_4i^s0)lco44r@quj'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / 'templates',  # This line ensures templates are looked for in a 'templates' folder at the project level
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
